...
void _get_ngram_hashes_cpp(py::array_t<int64_t> input_ids, py::array_t<int64_t> output_ids, int batch_size, int seq_len,
                           py::array_t<int64_t> multipliers, py::array_t<int64_t> head_vocab_sizes, int max_ngram_size,
...
void _lookup_cpp_f32(size_t num_embeddings, size_t embedding_dim, int64_t weight, int64_t indices, size_t batch_size,
                     size_t seq_len, size_t heads, int64_t output, int64_t offsets, int offsets_need = 0)
{
...
void _lookup_cpp_f16(size_t num_embeddings, size_t embedding_dim, int64_t weight, int64_t indices, size_t batch_size,
                     size_t seq_len, size_t heads, int64_t output, int64_t offsets, int offsets_need = 0)
{
